...
public class FloatingWidgetService extends Service implements View.OnClickListener {
  ...
  private View addRemoveView(LayoutInflater inflater) {
    Log.d("Notification", "add remove view");
  ...
  private void addFloatingWidgetView(LayoutInflater inflater) {
    ...
    Log.d("Notification", "addFloatingWidgetView");
  ...
  private void getWindowManagerDefaultDisplay() {
    Log.d("Notification", "getWindowManagerDefaultDisplay");
  ...
  private void implementTouchListenerToFloatingWidgetView() {
    ...
    Log.d("Notification", "implementTouchListenerToFloatingWidgetView");
  ...
  private void implementClickListeners() {
    Log.d("Notification", "implement click listener");
  ...
  private void onFloatingWidgetLongClick() {
    Log.d("Notification", "onFloatingWidgetLongClick");
  ...
  public void onConfigurationChanged(Configuration newConfig) {
    ...
    Log.d("Notification", "on configuration changed");
  ...
  private void onFloatingWidgetClick() {
    ...
    Log.d("Notification", "on floating widget click");

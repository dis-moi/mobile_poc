...
class DisMoiTrashLayout extends DisMoiBaseLayout {
    ...
    public DisMoiTrashLayout(Context context) {
        super(context);
    }

    public DisMoiTrashLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DisMoiTrashLayout(Context context, AttributeSet attrs, int defStyleAttr) {

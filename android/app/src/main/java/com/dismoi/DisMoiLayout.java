...
public class DisMoiLayout extends DisMoiBaseLayout {
    ...
    public DisMoiLayout(Context context) {
        super(context);
    ...
    public DisMoiLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        animator = new MoveAnimator();
        windowManager = (WindowManager) context.getSystemService(Context.WINDOW_SERVICE);
        initializeView();
    ...
    public DisMoiLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public interface OnBubbleRemoveListener {
        void onBubbleRemoved(DisMoiLayout bubble);
    }

    public interface OnBubbleClickListener {
        void onBubbleClick(DisMoiLayout bubble);
    }
